---
sidebar_position: 4
sidebar_label: Tenant Verification on your Nextjs App
---

import Tabs from "@theme/Tabs";
import TabItem from "@theme/TabItem";

# Tenant Verification on your Nextjs App

:::tip In a nutshell

Need to start verify tenants through your Nextjs app? In this article,
we'll be exploring how to connect Tenant verification with your Nextjs app.
...
If you’re already familiar with Nextjs, then this section would be pretty familiar to you and you can skip to the next section, Installing Paystack. If not, NextjsJS is a Javascript library used for building frontend applications. NPM and Yarn are popular installation methods when building large scale applications with Nextjs.
...
Once it’s installed, navigate to your desired folder and create a new Nextjs project;

```bash
Nextjs create project_name
```
...
<template>
  <div id="app">
    ...
    <img style="max-width:200px;" alt="Nextjs logo" src="./assets/pstk.png" />
  </div>
</template>
<script>
  export default {
...
To add this plugin to your Nextjs project;
...
Once it's installed, import the library into your App.Nextjs file like this

```js
<script>
import paystack from 'Nextjs-paystack';
...
We also have another sample sneakers store built in Nextjs, here's the repository and live demo.
