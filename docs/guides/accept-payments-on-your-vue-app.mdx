---
sidebar_position: 1
sidebar_label: Accept Payments on your Vue App
---
...
You should [create a free Paystack account](http://sdhsdsd.com). We'll provide you with test keys that you can use to make test your integration.
...
Now to add the [Paystack Vue package](http://sdsd.com), this package contains the Paystack Inline JS library and the checkout as a single component. To add this plugin to your vue project;
